...
export default function InferenceStudio({ config, onConfigChange }: Props) {
  ...
  async function saveInference() {
    ...
    try {
      ...
      onConfigChange({
        ...
        llm_max_tokens: clampedMaxTokens,
  ...
  return (
    <section className="mb-8">
      ...
      <div className="mb-4 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-5">
        ...
        <div className="mt-3 flex max-w-xs flex-col gap-1">
          ...
          <input
            ...
            onChange={(e) => setDefaultMaxTokens(Math.max(64, Number(e.target.value)))}
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl bg-gray-50 p-3 dark:bg-gray-900/60">
        <div className="mb-3 flex flex-wrap items-center gap-2">
          ...
          <button type="button" onClick={() => set({ max_concurrent_requests: 1, chat_reasoning_effort: "server_default" })} className="rounded-full border border-gray-300 px-3 py-1 text-xs font-medium text-gray-700 hover:bg-white dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-800">Local machine</button>
